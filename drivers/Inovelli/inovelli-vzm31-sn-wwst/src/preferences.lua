...
local devices = {
  INOVELLI_VZM31_SN = {
    ...
    PARAMETERS = {
      ...
      parameter18 = {parameter_number = 18, size = data_types.Uint16},
      parameter19 = {parameter_number = 19, size = data_types.Uint16},
      parameter20 = {parameter_number = 20, size = data_types.Uint16},
      parameter21 = {parameter_number = 21, size = data_types.Boolean},
      parameter25 = {parameter_number = 25, size = data_types.Boolean},
      ...
      parameter100 = {parameter_number = 100, size = data_types.Boolean},
      ...
      parameter261 = {parameter_number = 261, size = data_types.Boolean},
