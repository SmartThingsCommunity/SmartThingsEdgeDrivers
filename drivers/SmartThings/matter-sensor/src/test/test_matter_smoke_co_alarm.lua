...
local mock_device = test.mock_device.build_test_matter_device({
  profile = t_utils.get_profile_definition("smoke-co-alarm-battery-temperature-humidity.yml"),
  manufacturer_info = {
    vendor_id = 0x0000,
    product_id = 0x0000,
  },
...
local function test_init()
  ...
  mock_device:expect_metadata_update({ profile = "smoke-co-alarm-battery-temperature-humidity" })
end
