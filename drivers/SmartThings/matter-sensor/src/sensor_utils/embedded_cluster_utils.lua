...
local embedded_clusters_api_21 = {
  [clusters.SoilMeasurement.ID] = clusters.SoilMeasurement
}
...
function embedded_cluster_utils.get_endpoints(device, cluster_id, opts)
  ...
  if version.api < 10 and embedded_clusters_api_10[cluster_id] ~= nil or
     ...
     version.api < 21 and embedded_clusters_api_21[cluster_id] ~= nil then
    local embedded_cluster = embedded_clusters_api_10[cluster_id] or embedded_clusters_api_11[cluster_id] or
      embedded_clusters_api_21[cluster_id]
    local opts = opts or {}
