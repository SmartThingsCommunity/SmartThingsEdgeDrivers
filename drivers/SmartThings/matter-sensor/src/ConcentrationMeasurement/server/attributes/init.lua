...
local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.ConcentrationMeasurement.server.attributes")
if has_aliases then
  aliases:add_to_class(ConcentrationMeasurementServerAttributes)
end
