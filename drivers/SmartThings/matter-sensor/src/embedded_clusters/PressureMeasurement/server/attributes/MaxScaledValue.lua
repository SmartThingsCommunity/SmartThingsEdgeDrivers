...
--- @class st.matter.clusters.PressureMeasurement.MaxScaledValue
...
function MaxScaledValue:read(device, endpoint_id)
...
--- Reporting policy: MaxScaledValue => true => mandatory
...
--- @param endpoint_id number|nil
--- @return any
function MaxScaledValue:subscribe(device, endpoint_id)
...
--- Builds an MaxScaledValue test attribute reponse for the driver integration testing framework
---
...
function MaxScaledValue:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function MaxScaledValue:deserialize(tlv_buf)
