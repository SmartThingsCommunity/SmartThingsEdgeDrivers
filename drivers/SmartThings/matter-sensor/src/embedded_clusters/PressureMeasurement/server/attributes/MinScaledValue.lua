...
--- @class st.matter.clusters.PressureMeasurement.MinScaledValue
...
function MinScaledValue:read(device, endpoint_id)
...
--- Reporting policy: MinScaledValue => true => mandatory
...
--- @param endpoint_id number|nil
--- @return any
function MinScaledValue:subscribe(device, endpoint_id)
...
--- Builds an MinScaledValue test attribute reponse for the driver integration testing framework
---
...
function MinScaledValue:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function MinScaledValue:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)

  return data
end

setmetatable(MinScaledValue, {__call = MinScaledValue.new_value, __index = MinScaledValue.base_type})
