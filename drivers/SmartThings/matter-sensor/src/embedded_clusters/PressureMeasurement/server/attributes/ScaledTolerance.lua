...
--- @class st.matter.clusters.PressureMeasurement.ScaledTolerance
...
function ScaledTolerance:read(device, endpoint_id)
...
--- Reporting policy: ScaledTolerance => true => suggested
...
--- @param endpoint_id number|nil
--- @return any
function ScaledTolerance:subscribe(device, endpoint_id)
...
--- Builds an ScaledTolerance test attribute reponse for the driver integration testing framework
---
...
function ScaledTolerance:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function ScaledTolerance:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)

  return data
end

setmetatable(ScaledTolerance, {__call = ScaledTolerance.new_value, __index = ScaledTolerance.base_type})
