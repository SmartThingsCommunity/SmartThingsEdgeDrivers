...
local PressureMeasurementServerCommands = require "embedded_clusters.PressureMeasurement.server.commands"
local PressureMeasurementTypes = require "embedded_clusters.PressureMeasurement.types"
