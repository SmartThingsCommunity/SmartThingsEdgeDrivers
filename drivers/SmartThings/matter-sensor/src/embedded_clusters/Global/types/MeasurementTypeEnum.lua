...
new_mt.__index.REACTIVE_ENERGY  = 0x0F
new_mt.__index.APPARENT_ENERGY  = 0x10
new_mt.__index.SOIL_MOISTURE  = 0x11
...
MeasurementTypeEnum.REACTIVE_ENERGY  = 0x0F
MeasurementTypeEnum.APPARENT_ENERGY  = 0x10
MeasurementTypeEnum.SOIL_MOISTURE  = 0x11

MeasurementTypeEnum.augment_type = function(_cls, val)
