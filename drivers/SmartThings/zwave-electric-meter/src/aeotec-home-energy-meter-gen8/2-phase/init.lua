...
local HEM8_DEVICES = {
  { profile = 'aeotec-home-energy-meter-gen8-3-phase-con', name = 'Aeotec Home Energy Meter 8 Consumption', endpoints = { 1, 3, 5 } },
  { profile = 'aeotec-home-energy-meter-gen8-2-phase-pro', name = 'Aeotec Home Energy Meter 8 Production', child_key = 'pro', endpoints = { 2, 4, 6 } },
...
local function can_handle_aeotec_meter_gen8_2_phase(opts, driver, device, ...)
...
local aeotec_home_energy_meter_gen8_2_phase = {
  ...
  can_handle = can_handle_aeotec_meter_gen8_2_phase
}

return aeotec_home_energy_meter_gen8_2_phase
