...
local mock_device = test.mock_device.build_test_zwave_device({
    profile = t_utils.get_profile_definition("smartplug-switch-2.yml"),
    ...
    {
      {
        channel = "capability",
        direction = "receive",
        message = { mock_device.id, { capability = "switch", component = "switch2", command = "on", args = { } } }
      },
      {
        channel = "zwave",
        direction = "send",
    ...
    {
      {
        channel = "capability",
        direction = "receive",
        message = { mock_device.id, { capability = "switch", component = "switch2", command = "off", args = { } } }
      },
      {
        channel = "zwave",
        direction = "send",
