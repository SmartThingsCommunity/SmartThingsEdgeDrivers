...
local mock_parent_device = test.mock_device.build_test_zwave_device({
  profile = profile,
  label = "Wave Pro 2PM 1",
  zwave_endpoints = switch_multicomponent_endpoints,
  zwave_manufacturer_id = SHELLY_MANUFACTURER_ID,
  zwave_product_type = SHELLY_PRODUCT_TYPE,
  zwave_product_id = SHELLY_PRODUCT_ID
})
