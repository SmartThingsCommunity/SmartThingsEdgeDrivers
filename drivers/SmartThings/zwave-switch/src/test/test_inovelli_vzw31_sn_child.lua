...
-- Test child device switch on command (Gen3 uses parameter 99, same as vzw32)
test.register_coroutine_test(
  "Child device switch on should emit events and send configuration to parent",
  function()
    test.timer.__create_and_queue_test_time_advance_timer(1, "oneshot")

    -- Calculate expected configuration value using the same logic as getNotificationValue (Gen3)
