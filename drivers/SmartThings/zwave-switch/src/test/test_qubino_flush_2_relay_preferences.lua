...
do
  ...
  test.register_coroutine_test(
    ...
    function()
      test.socket.device_lifecycle:__queue_receive(mock_qubino_flush_2_relay:generate_info_changed({preferences = {input1SwitchType = new_param_value}}))
...
do
  ...
  test.register_coroutine_test(
    ...
    function()
      test.socket.device_lifecycle:__queue_receive(mock_qubino_flush_2_relay:generate_info_changed({preferences = {input2SwitchType = new_param_value}}))
      test.socket.zwave:__expect_send(
        zw_test_utils.zwave_test_build_send_command(
                mock_qubino_flush_2_relay,
          Configuration:Set({
...
do
  ...
  test.register_coroutine_test(
    ...
    function()
      test.socket.device_lifecycle:__queue_receive(mock_qubino_flush_2_relay:generate_info_changed({preferences = {saveStateAfterPowerFail = new_param_value}}))
      test.socket.zwave:__expect_send(
        zw_test_utils.zwave_test_build_send_command(
                mock_qubino_flush_2_relay,
          Configuration:Set({
...
do
  ...
  test.register_coroutine_test(
    ...
    function()
      test.socket.device_lifecycle:__queue_receive(mock_qubino_flush_2_relay:generate_info_changed({preferences = {outputQ1SwitchSelection = new_param_value}}))
      test.socket.zwave:__expect_send(
        zw_test_utils.zwave_test_build_send_command(
                mock_qubino_flush_2_relay,
          Configuration:Set({
...
do
  ...
  test.register_coroutine_test(
    ...
    function()
      test.socket.device_lifecycle:__queue_receive(mock_qubino_flush_2_relay:generate_info_changed({preferences = {outputQ2SwitchSelection = new_param_value}}))
      test.socket.zwave:__expect_send(
        zw_test_utils.zwave_test_build_send_command(
                mock_qubino_flush_2_relay,
          Configuration:Set({
