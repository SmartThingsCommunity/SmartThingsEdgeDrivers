...
test.register_coroutine_test(
  ...
  function()
    ...
    test.socket.capability:__expect_send(
      mock_device:generate_test_message("main", capabilities.windMode.supportedWindModes({value = supportedFanWind}, {visibility = {displayed = false}}))
    )
    mock_device:expect_metadata_update({ profile = "room-air-conditioner" })
  end
)
