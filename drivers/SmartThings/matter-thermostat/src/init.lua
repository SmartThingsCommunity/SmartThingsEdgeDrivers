...
local function fan_mode_handler(driver, device, ib, response)
  ...
  if fan_mode_idx and fan_mode_idx >= 1 and fan_mode_idx <= 4 and fan_mode_event[ib.data.value][fan_mode_idx] then
...
local function fan_mode_sequence_handler(driver, device, ib, response)
  local supported_fan_modes_attribute, supportedFanModes
