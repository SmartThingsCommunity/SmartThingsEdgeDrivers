...
--- @return boolean
function ThermostatUtils.deep_equals(a, b, opts, seen)
  ...
  for k, v in next, a do
    if not ThermostatUtils.deep_equals(v, rawget(b, k), opts, seen) then
      return false
    end
  end
  ...
  return ThermostatUtils.deep_equals(mt_a, mt_b, opts, seen)
end
