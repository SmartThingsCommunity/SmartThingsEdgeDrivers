...
local function test_clild_changeToWirelessSwitch_false(ep, name)
  test.register_coroutine_test(name, function()
...
for ep = 1, 3 do
  test_clild_changeToWirelessSwitch_true(ep, "children infoChanged - stse.changeToWirelessSwitch true " .. ep + 1)
end

for ep = 1, 3 do
  test_clild_changeToWirelessSwitch_false(ep, "children infoChanged - stse.changeToWirelessSwitch false " .. ep + 1)
end
