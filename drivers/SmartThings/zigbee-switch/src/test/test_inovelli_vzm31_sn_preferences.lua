...
test.register_coroutine_test(
  ...
  function()
    ...
    test.socket.device_lifecycle:__queue_receive(mock_inovelli_vzm31_sn:generate_info_changed({preferences = {parameter1 = new_param_value}}))
...
test.register_coroutine_test(
  ...
  function()
    ...
    test.socket.device_lifecycle:__queue_receive(mock_inovelli_vzm31_sn:generate_info_changed({preferences = {parameter9 = new_param_value}}))
...
test.register_coroutine_test(
  ...
  function()
    ...
    test.socket.device_lifecycle:__queue_receive(mock_inovelli_vzm31_sn:generate_info_changed({preferences = {parameter52 = new_param_value}}))
...
test.register_coroutine_test(
  ...
  function()
    ...
    test.socket.device_lifecycle:__queue_receive(mock_inovelli_vzm31_sn:generate_info_changed({preferences = {parameter258 = new_param_value}}))
...
test.register_coroutine_test(
  "parameter11 preference should send configuration command",
  function()
    local new_param_value = true
    test.socket.device_lifecycle:__queue_receive(mock_inovelli_vzm31_sn:generate_info_changed({preferences = {parameter11 = new_param_value}}))
...
test.register_coroutine_test(
  ...
  function()
    ...
    test.socket.device_lifecycle:__queue_receive(mock_inovelli_vzm31_sn:generate_info_changed({preferences = {parameter17 = new_param_value}}))
...
test.register_coroutine_test(
  "parameter22 preference should send configuration command",
  function()
    local new_param_value = 2
    test.socket.device_lifecycle:__queue_receive(mock_inovelli_vzm31_sn:generate_info_changed({preferences = {parameter22 = new_param_value}}))
...
test.register_coroutine_test(
  ...
  function()
    mock_inovelli_vzm31_sn:expect_device_create({
      type = "EDGE_CHILD",
      label = "Inovelli VZM31-SN Notification",
      profile = "rgbw-bulb-2700K-6500K",
      parent_device_id = mock_inovelli_vzm31_sn.id,
