  ...
  {
    {
      channel = "capability",
      direction = "receive",
      message = {mock_device.id, {capability = "switchLevel", component = "main", command = "setLevel", args = { 57 }}}
    },
    {
      channel = "zigbee",
      direction = "send",
      message = {
        mock_device.id,
        Level.server.commands.MoveToLevelWithOnOff(mock_device, math.floor(57 / 100 * 254 ), 0xFFFF)
      }
    },
    {
      channel = "zigbee",
