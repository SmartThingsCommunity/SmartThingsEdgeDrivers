...
test.register_coroutine_test(
  ...
  function()
    ...
    test.socket.device_lifecycle:__queue_receive(mock_inovelli_vzm30_sn:generate_info_changed({preferences = {parameter1 = new_param_value}}))
...
test.register_coroutine_test(
  ...
  function()
    ...
    test.socket.device_lifecycle:__queue_receive(mock_inovelli_vzm30_sn:generate_info_changed({preferences = {parameter52 = new_param_value}}))
...
test.register_coroutine_test(
  ...
  function()
    ...
    test.socket.device_lifecycle:__queue_receive(mock_inovelli_vzm30_sn:generate_info_changed({preferences = {parameter258 = new_param_value}}))
...
test.register_coroutine_test(
  ...
  function()
    local new_param_value = true
    test.socket.device_lifecycle:__queue_receive(mock_inovelli_vzm30_sn:generate_info_changed({preferences = {parameter11 = new_param_value}}))
...
test.register_coroutine_test(
  ...
  function()
    ...
    test.socket.device_lifecycle:__queue_receive(mock_inovelli_vzm30_sn:generate_info_changed({preferences = {parameter22 = new_param_value}}))
...
test.register_coroutine_test(
  ...
  function()
    mock_inovelli_vzm30_sn:expect_device_create({
      type = "EDGE_CHILD",
      label = "Inovelli VZM30-SN Notification",
      profile = "rgbw-bulb-2700K-6500K",
      parent_device_id = mock_inovelli_vzm30_sn.id,
