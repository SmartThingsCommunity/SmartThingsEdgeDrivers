...
local preference_map = {
      ...
      parameter101 = {parameter_number = 101, size = data_types.Int16},
      parameter102 = {parameter_number = 102, size = data_types.Int16},
      parameter103 = {parameter_number = 103, size = data_types.Int16},
      parameter104 = {parameter_number = 104, size = data_types.Int16},
      parameter105 = {parameter_number = 105, size = data_types.Int16},
      parameter106 = {parameter_number = 106, size = data_types.Int16},
      parameter110 = {parameter_number = 110, size = data_types.Uint8},
      parameter111 = {parameter_number = 111, size = data_types.Uint32},
      parameter112 = {parameter_number = 112, size = data_types.Uint8},
...
local is_inovelli_vzm32_sn = function(opts, driver, device)
  for _, fingerprint in ipairs(INOVELLI_VZM32_SN_FINGERPRINTS) do
    if device:get_manufacturer() == fingerprint.mfr and device:get_model() == fingerprint.model then
      local subdriver = require("inovelli-vzm32-sn")
