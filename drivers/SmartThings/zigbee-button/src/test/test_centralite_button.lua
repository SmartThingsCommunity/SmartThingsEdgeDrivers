...
local mock_device = test.mock_device.build_test_zigbee_device(
    {
      ...
      zigbee_endpoints = {
        [1] = {
          ...
          model = "3450-L",
          client_clusters = {0x0006},
          server_clusters = {0x0000, 0x0001, 0x0003, 0x0007, 0x0020, 0x0B05}
        },
        [2] = {
          id = 2,
          client_clusters = {0x0006},
          server_clusters = {0x0007}
        },
        [3] = {
          id = 3,
          client_clusters = {0x0006},
...
test.register_coroutine_test(
    ...
    function()
      test.socket.zigbee:__queue_receive({ mock_device.id, zigbee_test_utils.build_custom_command_id(mock_device, OnOff.ID, OnOff.server.commands.On.ID, 0x0000, "\x00", 0x01) })
      test.socket.zigbee:__queue_receive({ mock_device.id, zigbee_test_utils.build_custom_command_id(mock_device, OnOff.ID, OnOff.server.commands.Off.ID, 0x0000, "\x00", 0x01) })
      ...
      test.socket.zigbee:__queue_receive({ mock_device.id, zigbee_test_utils.build_custom_command_id(mock_device, OnOff.ID, OnOff.server.commands.On.ID, 0x0000, "\x00", 0x02) })
      test.socket.zigbee:__queue_receive({ mock_device.id, zigbee_test_utils.build_custom_command_id(mock_device, OnOff.ID, OnOff.server.commands.Off.ID, 0x0000, "\x00", 0x02) })
      test.socket.capability:__expect_send(
      ...
      test.socket.zigbee:__queue_receive({ mock_device.id, zigbee_test_utils.build_custom_command_id(mock_device, OnOff.ID, OnOff.server.commands.On.ID, 0x0000, "\x00", 0x03) })
      test.socket.zigbee:__queue_receive({ mock_device.id, zigbee_test_utils.build_custom_command_id(mock_device, OnOff.ID, OnOff.server.commands.Off.ID, 0x0000, "\x00", 0x03) })
      test.socket.capability:__expect_send(
