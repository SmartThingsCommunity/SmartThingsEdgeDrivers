...
local function on_off_attr_handler(driver, device, ib, response)
  local child_device = device:get_child_by_parent_assigned_key(string.format("%d", ib.endpoint_id))
  if ib.data.value then
    ...
    -- device here is the parent device with the power consumption metrics
...
local eve_energy_outlet_handler = {
  NAME = "Eve Energy Outlet Handler",
  lifecycle_handlers = {
    init = device_init,
    added = device_added,
...
return eve_energy_outlet_handler