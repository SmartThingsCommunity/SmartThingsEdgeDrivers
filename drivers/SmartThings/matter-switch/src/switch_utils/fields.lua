...
SwitchFields.DEVICE_TYPE_ID = {
  ...
  BRIDGED_NODE = 0x0013,
  CAMERA = 0x0142,
  CAMERA_AUDIO_DOORBELL = 0x0141,
  CAMERA_FLOODLIGHT = 0x0144,
  CAMERA_INTERCOM = 0x0140,
  CAMERA_SNAPSHOT = 0x0145,
  CAMERA_VIDEO_DOORBELL = 0x0143,
  CHIME = 0x0146,
...
SwitchFields.device_type_profile_map = {
  ...
  [SwitchFields.DEVICE_TYPE_ID.WINDOW_COVERING] = "window-covering"
}
...
SwitchFields.vendor_overrides = {
  ...
  [0x1285] = { -- HAGER_MANUFACTURER_ID
    [0x0005] = { needs_hager_subdriver = true }, -- Hager HBnet 1g switch
