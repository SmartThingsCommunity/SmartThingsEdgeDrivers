...
function DeviceConfiguration.match_profile(driver, device)
  ...
  if #window_covering_ep_ids > 0 then
    DeviceConfiguration.create_or_update_child_devices(driver, device, window_covering_ep_ids, default_endpoint_id, WindowCoveringDeviceConfiguration.assign_profile_for_window_covering_ep)
  end
