...
local mock_device = test.mock_device.build_test_matter_device({
  ...
  endpoints = {
    ...
    },
    {
      ...
      device_types = {
        { device_type_id = 0x0011, device_type_revision = 1 }, -- Power Source
      }
    },
  }
})
...
test.register_coroutine_test("Read appropriate attribute values after tempOffset preference change",
  function()
...
test.register_coroutine_test("Read appropriate attribute values after humidityOffset preference change",
  function()
