...
--- invoke smartthings:audio/setMute on ip
---@param ip string
function APIs.Mute(ip)
    return invoke.Activate(ip, SMARTTHINGS_AUDIO_PATH .. "setMute")
end

--- invoke smartthings:audio/setUnmute on ip
---@param ip string
function APIs.Unmute(ip)
    return invoke.Activate(ip, SMARTTHINGS_AUDIO_PATH .. "setUnmute")
end
...
--- invoke smartthings:audio/setVolUp on ip
---@param ip string
function APIs.VolUp(ip)
    return invoke.Activate(ip, SMARTTHINGS_AUDIO_PATH .. "setVolUp")
end

--- invoke smartthings:audio/setVolDown on ip
---@param ip string
function APIs.VolDown(ip)
    return invoke.Activate(ip, SMARTTHINGS_AUDIO_PATH .. "setVolDown")
end

--- invoke smartthings:audio/getAudioTrackData on ip
---@param ip string
function APIs.getAudioTrackData(ip)
    local ret = invoke.Activate(ip, SMARTTHINGS_AUDIO_PATH .. "getAudioTrackData")
    local trackdata = {
        title = ret.title,
        artist = ret.artist,
        album = ret.album,
        albumArtUrl = ret.albumArtUrl,
        mediaSource = ret.mediaSource
    }
    local totalTime = ret.totalTime
    local elapsedTime = ret.elapsedTime
