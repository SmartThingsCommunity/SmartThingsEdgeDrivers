...
local mock_device_maestro = test.mock_device.build_test_zigbee_device({ profile = zigbee_thermostat_profile, zigbee_endpoints ={ [1] = {id = 1, manufacturer = "Stello", model = "HT402", server_clusters = {0x0201, 0x0204, 0x0405}} } })
...
test.register_coroutine_test(
    "Refresh necessary attributes - HT402",
    function()
...
test.register_coroutine_test(
    "Configure should configure all necessary attributes - HT402",
    function ()
      test.socket.zigbee:__set_channel_ordering("relaxed")
