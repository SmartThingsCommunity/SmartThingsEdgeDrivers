...
test.register_message_test(
  "temperatureSetpoint command should send appropriate commands for refrigerator endpoint, temp bounds out of range",
  {
    ...
    },
    {
      channel = "capability",
      direction = "send",
      message = mock_device:generate_test_message("refrigerator", capabilities.temperatureSetpoint.temperatureSetpointRange({value = {minimum=-10.0,maximum=30.0, step = 0.1}, unit = "C"}))
    },
    {
      channel = "capability",
      direction = "send",
...
test.register_message_test(
  "temperatureSetpoint command should send appropriate commands for freezer endpoint, temp bounds out of range",
  {
    ...
    },
    {
      channel = "capability",
      direction = "send",
      message = mock_device:generate_test_message("freezer", capabilities.temperatureSetpoint.temperatureSetpointRange({value = {minimum=-30.0,maximum=0.0, step = 0.1}, unit = "C"}))
    },
    {
      channel = "capability",
      direction = "send",
