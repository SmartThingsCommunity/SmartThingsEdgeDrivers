...
-----------------------------------------------------------
-- DishwasherAlarm command ModifyEnabledAlarms
-----------------------------------------------------------

--- @class st.matter.clusters.DishwasherAlarm.ModifyEnabledAlarms
--- @alias ModifyEnabledAlarms
---
--- @field public ID number 0x0001 the ID of this command
--- @field public NAME string "ModifyEnabledAlarms" the name of this command
--- @field public mask DishwasherAlarm.types.AlarmMap
...
---
--- @param self ModifyEnabledAlarms the template class for this command
--- @param device st.matter.Device the device to build this message to
--- @param mask DishwasherAlarm.types.AlarmMap
