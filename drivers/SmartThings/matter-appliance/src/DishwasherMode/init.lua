...
do
  local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.DishwasherMode.server.attributes")
  if has_aliases then
    for alias, _ in pairs(aliases) do
      DishwasherMode.attribute_direction_map[alias] = "server"
    end
  end
end
