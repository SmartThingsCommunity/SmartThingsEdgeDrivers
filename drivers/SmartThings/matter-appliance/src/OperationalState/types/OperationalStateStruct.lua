...
OperationalStateStruct.field_defs = {
  {
...
OperationalStateStruct.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
OperationalStateStruct.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = OperationalStateStruct.init
new_mt.__index.serialize = OperationalStateStruct.serialize

OperationalStateStruct.augment_type = function(self, val)
  local elems = {}
