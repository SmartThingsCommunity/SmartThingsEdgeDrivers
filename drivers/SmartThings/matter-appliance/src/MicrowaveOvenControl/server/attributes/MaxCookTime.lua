...
function MaxCookTime:read(device, endpoint_id)
...
function MaxCookTime:subscribe(device, endpoint_id)
...
function MaxCookTime:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

function MaxCookTime:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
