...
local mock_device = test.mock_device.build_test_zigbee_device(
        { profile = t_utils.get_profile_definition("frient-contact-battery-temperature.yml"),
          zigbee_endpoints = {
              [0x01] = {
                  id = 0x01,
...
test.register_message_test(
        "Reported ZoneStatus should be handled: contact/closed",
        {
            {
                channel = "zigbee",
                direction = "receive",
...
test.register_message_test(
        "Reported ZoneStatus should be handled: contact/open",
        {
            {
                channel = "zigbee",
                direction = "receive",
