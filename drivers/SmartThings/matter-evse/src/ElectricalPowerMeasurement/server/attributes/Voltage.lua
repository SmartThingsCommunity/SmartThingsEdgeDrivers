...
function Voltage:augment_type(base_type_obj)
  base_type_obj.field_name = self.NAME
  base_type_obj.pretty_print = self.pretty_print
end

function Voltage.pretty_print(value_obj)
  return string.format("%s.%s", value_obj.field_name or value_obj.NAME, Voltage.enum_fields[value_obj.value])
end
...
setmetatable(Voltage, {__call = Voltage.new_value})
return Voltage
