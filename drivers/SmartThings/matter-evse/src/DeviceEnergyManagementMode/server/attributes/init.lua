...
attr_mt.__index = function(self, key)
  if attr_mt.__attr_cache[key] == nil then
    local req_loc = string.format("DeviceEnergyManagementMode.server.attributes.%s", key)
...
local DeviceEnergyManagementModeServerAttributes = {}

function DeviceEnergyManagementModeServerAttributes:set_parent_cluster(cluster)
