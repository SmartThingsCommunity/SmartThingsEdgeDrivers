...
function Disable:build_test_command_response(device, endpoint_id, status)
...
function Disable:init(device, endpoint_id)
  local out = {}
  local args = {}
  ...
  setmetatable(out, {
    __index = Disable,
    __tostring = Disable.pretty_print
  })
...
function Disable:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

function Disable:augment_type(base_type_obj)
  local elems = {}
...
function Disable:deserialize(tlv_buf)
