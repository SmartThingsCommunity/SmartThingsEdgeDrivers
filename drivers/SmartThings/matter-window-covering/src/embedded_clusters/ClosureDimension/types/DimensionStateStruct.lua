...
local DimensionStateStruct = {}
local new_mt = StructureABC.new_mt({NAME = "DimensionStateStruct", ID = data_types.name_to_id_map["Structure"]})

DimensionStateStruct.field_defs = {
  {
    name = "position",
    field_id = 0,
    is_nullable = true,
...
DimensionStateStruct.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
DimensionStateStruct.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = DimensionStateStruct.init
new_mt.__index.serialize = DimensionStateStruct.serialize

DimensionStateStruct.augment_type = function(self, val)
  local elems = {}
...
setmetatable(DimensionStateStruct, new_mt)

return DimensionStateStruct
