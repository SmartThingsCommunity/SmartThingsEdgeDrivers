...
--- @field public light_id_to_device table<string,HueDevice>
...
--- @field private _lights_pending_refresh table<string,HueDevice>
--- @field public emit_light_status_events fun(light_device: HueDevice, light: table)
