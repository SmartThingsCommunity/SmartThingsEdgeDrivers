...
function multi_service_device_utils.get_all_service_states(sensor_device_type, api_instance, device_service_id, bridge_id)
  return lazy_disco_handlers[sensor_device_type].update_state_for_all_device_services(api_instance, device_service_id, bridge_id)
end
