...
function m.create_already_onboarded_bridge_device(driver_under_test)
  ...
  if driver_under_test.datastore["bridge_netinfo"] == nil then
    driver_under_test.datastore["bridge_netinfo"] = {}
  end
  driver_under_test.datastore.bridge_netinfo[bridge_id] = mock_bridge_info

  if driver_under_test.datastore["dni_to_device_id"] == nil then
    driver_under_test.datastore["dni_to_device_id"] = {}
  end
  driver_under_test.datastore.dni_to_device_id[bridge_id] = mock_bridge_device.id


  if driver_under_test.datastore["api_keys"] == nil then
    driver_under_test.datastore["api_keys"] = {}
  end
