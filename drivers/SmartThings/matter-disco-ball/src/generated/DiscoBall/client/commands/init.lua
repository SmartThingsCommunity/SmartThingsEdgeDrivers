...
command_mt.__index = function(self, key)
  if command_mt.__command_cache[key] == nil then
    local req_loc = string.format("generated.DiscoBall.client.commands.%s", key)
...
--- @class generated.DiscoBallClientCommands
---
--- @field public StatsResponse generated.DiscoBall.StatsResponse
