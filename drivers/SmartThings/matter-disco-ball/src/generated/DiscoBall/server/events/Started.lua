...
--- @class st.matter.clusters.DiscoBall.Started
--- @alias Started
---
--- @field public ID number 0x0000 the ID of this event
--- @field public NAME string "Started" the name of this event
local Started = {
  ID = 0x0000,
  NAME = "Started",
...
function Started:augment_type(base_type_obj)
  local elems = {}
...
function Started:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return st.matter.interaction_model.InteractionRequest
function Started:subscribe(device, endpoint_id)
...
--- Builds an Started test event report reponse to be used by
...
function Started:build_test_event_report(
  device,
  endpoint_id,
  fields,
  status
  ...
  data.elements = {}
  data.num_elements = 0
  setmetatable(data, StructureABC.new_mt({NAME = "StartedEventData", ID = 0x15}))
...
function Started:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

function Started:set_parent_cluster(cluster)
