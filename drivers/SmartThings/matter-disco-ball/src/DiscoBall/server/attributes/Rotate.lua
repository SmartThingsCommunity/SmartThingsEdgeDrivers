...
--- @class st.matter.clusters.DiscoBall.Rotate
--- @alias Rotate
---
--- @field public ID number 0x0001 the ID of this attribute
--- @field public NAME string "Rotate" the name of this attribute
...
Rotate.CLOCKWISE = 0x01
Rotate.COUNTER_CLOCKWISE = 0x02

Rotate.enum_fields = {
  [Rotate.CLOCKWISE] = "CLOCKWISE",
  [Rotate.COUNTER_CLOCKWISE] = "COUNTER_CLOCKWISE",
}

--- Add additional functionality to the base type object
---
--- @param base_type_obj st.matter.data_types.Uint8 the base data type object to add functionality to
function Rotate:augment_type(base_type_obj)
  base_type_obj.field_name = self.NAME
  base_type_obj.pretty_print = self.pretty_print
end

function Rotate.pretty_print(value_obj)
  return string.format("%s.%s", value_obj.field_name or value_obj.NAME, Rotate.enum_fields[value_obj.value])
end
--- Create a Uint8 object of this attribute with any additional features provided for the attribute
--- This is also usable with the Rotate(...) syntax
---
--- @vararg vararg the values needed to construct a Uint8
--- @return st.matter.data_types.Uint8
function Rotate:new_value(...)
...
function Rotate:read(device, endpoint_id)
...
--- Reporting policy: Rotate => true => mandatory
...
--- @param endpoint_id number|nil
--- @return any
function Rotate:subscribe(device, endpoint_id)
...
function Rotate:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

--- Builds an Rotate test attribute reponse for the driver integration testing framework
---
...
function Rotate:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function Rotate:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(Rotate, {__call = Rotate.new_value})
return Rotate
