...
--- @class st.matter.clusters.DiscoBall.WobbleSetting
--- @alias WobbleSetting
---
--- @field public ID number 0x0008 the ID of this attribute
--- @field public NAME string "WobbleSetting" the name of this attribute
...
WobbleSetting.enum_fields = {
}

--- Add additional functionality to the base type object
---
--- @param base_type_obj st.matter.data_types.Uint8 the base data type object to add functionality to
function WobbleSetting:augment_type(base_type_obj)
  base_type_obj.field_name = self.NAME
  base_type_obj.pretty_print = self.pretty_print
end

function WobbleSetting.pretty_print(value_obj)
  return string.format("%s.%s", value_obj.field_name or value_obj.NAME, WobbleSetting.enum_fields[value_obj.value])
end
--- Create a Uint8 object of this attribute with any additional features provided for the attribute
--- This is also usable with the WobbleSetting(...) syntax
---
--- @vararg vararg the values needed to construct a Uint8
--- @return st.matter.data_types.Uint8
function WobbleSetting:new_value(...)
...
function WobbleSetting:read(device, endpoint_id)
...
function WobbleSetting:write(device, endpoint_id, value)
...
--- Reporting policy: WobbleSetting => true => mandatory
...
--- @param endpoint_id number|nil
--- @return any
function WobbleSetting:subscribe(device, endpoint_id)
...
function WobbleSetting:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

--- Builds an WobbleSetting test attribute reponse for the driver integration testing framework
---
...
function WobbleSetting:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function WobbleSetting:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(WobbleSetting, {__call = WobbleSetting.new_value})
return WobbleSetting
