...
--- @class st.matter.clusters.DiscoBall.Run
--- @alias Run
---
--- @field public ID number 0x0000 the ID of this attribute
--- @field public NAME string "Run" the name of this attribute
...
function Run:read(device, endpoint_id)
...
--- Reporting policy: Run => true => mandatory
...
--- @param endpoint_id number|nil
--- @return any
function Run:subscribe(device, endpoint_id)
...
function Run:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

--- Builds an Run test attribute reponse for the driver integration testing framework
---
...
function Run:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function Run:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(Run, {__call = Run.new_value})
return Run
