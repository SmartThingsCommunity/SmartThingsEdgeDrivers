...
function OnOff:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function OnOff:subscribe(device, endpoint_id)
...
function OnOff:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function OnOff:deserialize(tlv_buf)
