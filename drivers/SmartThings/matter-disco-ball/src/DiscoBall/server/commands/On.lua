...
function On:build_test_command_response(device, endpoint_id, status)
...
function On:init(device, endpoint_id)
  local out = {}
  local args = {}
...
function On:augment_type(base_type_obj)
  local elems = {}
...
function On:deserialize(tlv_buf)
