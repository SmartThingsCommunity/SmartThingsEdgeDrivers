...
local DiscoBallServerAttributes = require "DiscoBall.server.attributes"
local DiscoBallServerCommands = require "DiscoBall.server.commands"
local DiscoBallTypes = require "DiscoBall.types"
...
--- @field public attributes DiscoBallServerAttributes | DiscoBallClientAttributes
--- @field public commands DiscoBallServerCommands | DiscoBallClientCommands
--- @field public types DiscoBallTypes
...
DiscoBall.FeatureMap = DiscoBall.types.DiscoBallFeature
