...
local DiscoBallServerAttributes = require "st.matter.clusters.generated.DiscoBall.server.attributes"
local DiscoBallServerCommands = require "st.matter.clusters.generated.DiscoBall.server.commands"
local DiscoBallClientCommands = require "st.matter.clusters.generated.DiscoBall.client.commands"
local DiscoBallEvents = require "st.matter.clusters.generated.DiscoBall.server.events"
local DiscoBallTypes = require "st.matter.clusters.generated.DiscoBall.types"

--- @class st.matter.clusters.generated.DiscoBall
--- @alias DiscoBall
---
--- @field public ID number 0x3456 the ID of this cluster
--- @field public NAME string "DiscoBall" the name of this cluster
--- @field public attributes st.matter.clusters.generated.DiscoBallServerAttributes | st.matter.clusters.generated.DiscoBallClientAttributes
--- @field public commands st.matter.clusters.generated.DiscoBallServerCommands | st.matter.clusters.generated.DiscoBallClientCommands
--- @field public types st.matter.clusters.generated.DiscoBallTypes
