...
local shus_smart_mattress = {
  ...
  capability_handlers = {
    ...
    [custom_capabilities.left_control.ID] = {
      ["backControl"] = process_capabilities_factory("backControl","left_back"),
      ["waistControl"] = process_capabilities_factory("waistControl","left_waist"),
      ["hipControl"] = process_capabilities_factory("hipControl","left_hip")
    },
    [custom_capabilities.right_control.ID] = {
      ["backControl"] = process_capabilities_factory("backControl","right_back"),
      ["waistControl"] = process_capabilities_factory("waistControl","right_waist"),
      ["hipControl"] = process_capabilities_factory("hipControl","right_hip")
    },
