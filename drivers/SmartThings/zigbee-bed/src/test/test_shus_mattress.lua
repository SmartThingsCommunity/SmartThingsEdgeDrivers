...
test.register_coroutine_test(
  "Device reported leftback 0 and driver emit custom_capabilities.left_control.leftback.soft()",
  function()
...
test.register_coroutine_test(
  "Device reported leftback 1 and driver emit custom_capabilities.left_control.leftback.medium()",
  function()
    local attr_report_data = {
    ...
    test.socket.capability:__expect_send(mock_device:generate_test_message("main",
      custom_capabilities.left_control.leftback.medium()))
  end
)

test.register_coroutine_test(
  "Device reported leftback 2 and driver emit custom_capabilities.left_control.leftback.hard()",
  function()
    local attr_report_data = {
...
test.register_coroutine_test(
  "Device reported leftwaist 0 and driver emit custom_capabilities.left_control.leftwaist.soft()",
  function()
    local attr_report_data = {
...
test.register_coroutine_test(
  "Device reported leftwaist 1 and driver emit custom_capabilities.left_control.leftwaist.medium()",
  function()
    local attr_report_data = {
    ...
    test.socket.capability:__expect_send(mock_device:generate_test_message("main",
      custom_capabilities.left_control.leftwaist.medium()))
  end
)

test.register_coroutine_test(
  "Device reported leftwaist 2 and driver emit custom_capabilities.left_control.leftwaist.hard()",
  function()
    local attr_report_data = {
      { 0x0001, data_types.Uint8.ID, 2 }
    }
    test.socket.zigbee:__queue_receive({
      mock_device.id,
      zigbee_test_utils.build_attribute_report(mock_device, PRIVATE_CLUSTER_ID, attr_report_data, MFG_CODE)
...
test.register_coroutine_test(
  "Device reported lefthip 0 and driver emit custom_capabilities.left_control.lefthip.soft()",
  function()
    local attr_report_data = {
...
test.register_coroutine_test(
  "Device reported lefthip 1 and driver emit custom_capabilities.left_control.lefthip.medium()",
  function()
    local attr_report_data = {
    ...
    test.socket.capability:__expect_send(mock_device:generate_test_message("main",
      custom_capabilities.left_control.lefthip.medium()))
  end
)

test.register_coroutine_test(
  "Device reported lefthip 2 and driver emit custom_capabilities.left_control.lefthip.hard()",
  function()
    local attr_report_data = {
      { 0x0002, data_types.Uint8.ID, 2 }
    }
    test.socket.zigbee:__queue_receive({
      mock_device.id,
      zigbee_test_utils.build_attribute_report(mock_device, PRIVATE_CLUSTER_ID, attr_report_data, MFG_CODE)
...
test.register_coroutine_test(
  "Device reported rightback 0 and driver emit custom_capabilities.right_control.rightback.soft()",
  function()
    local attr_report_data = {
...
test.register_coroutine_test(
  "Device reported rightback 1 and driver emit custom_capabilities.right_control.rightback.medium()",
  function()
    local attr_report_data = {
    ...
    test.socket.capability:__expect_send(mock_device:generate_test_message("main",
      custom_capabilities.right_control.rightback.medium()))
  end
)

test.register_coroutine_test(
  "Device reported rightback 2 and driver emit custom_capabilities.right_control.rightback.hard()",
  function()
    local attr_report_data = {
...
test.register_coroutine_test(
  "Device reported rightwaist 0 and driver emit custom_capabilities.right_control.rightwaist.soft()",
  function()
    local attr_report_data = {
...
test.register_coroutine_test(
  "Device reported rightwaist 1 and driver emit custom_capabilities.right_control.rightwaist.medium()",
  function()
    local attr_report_data = {
    ...
    test.socket.capability:__expect_send(mock_device:generate_test_message("main",
      custom_capabilities.right_control.rightwaist.medium()))
  end
)

test.register_coroutine_test(
  "Device reported rightwaist 2 and driver emit custom_capabilities.right_control.rightwaist.hard()",
  function()
    local attr_report_data = {
...
test.register_coroutine_test(
  "Device reported righthip 0 and driver emit custom_capabilities.right_control.righthip.soft()",
  function()
    local attr_report_data = {
...
test.register_coroutine_test(
  "Device reported righthip 1 and driver emit custom_capabilities.right_control.righthip.medium()",
  function()
    local attr_report_data = {
    ...
    test.socket.capability:__expect_send(mock_device:generate_test_message("main",
      custom_capabilities.right_control.righthip.medium()))
  end
)

test.register_coroutine_test(
  "Device reported righthip 2 and driver emit custom_capabilities.right_control.righthip.hard()",
  function()
    local attr_report_data = {
...
test.register_coroutine_test(
  "capability left_control backControl medium and driver send medium ",
  function()
    test.socket.capability:__queue_receive({
      mock_device.id,
      { capability = custom_capabilities.left_control.ID, component = "main", command ="backControl" , args = {"medium"}}
    })
    test.socket.zigbee:__expect_send({ mock_device.id,
      cluster_base.write_manufacturer_specific_attribute(mock_device, PRIVATE_CLUSTER_ID,
...
test.register_coroutine_test(
  "capability waistControl backControl medium and driver send medium ",
  function()
    test.socket.capability:__queue_receive({
      mock_device.id,
      { capability = custom_capabilities.left_control.ID, component = "main", command ="waistControl" , args = {"medium"}}
    })
    test.socket.zigbee:__expect_send({ mock_device.id,
      cluster_base.write_manufacturer_specific_attribute(mock_device, PRIVATE_CLUSTER_ID,
...
test.register_coroutine_test(
  "capability left_control hipControl medium and driver send medium ",
  function()
    test.socket.capability:__queue_receive({
      mock_device.id,
      { capability = custom_capabilities.left_control.ID, component = "main", command ="hipControl" , args = {"medium"}}
    })
    test.socket.zigbee:__expect_send({ mock_device.id,
      cluster_base.write_manufacturer_specific_attribute(mock_device, PRIVATE_CLUSTER_ID,
...
test.register_coroutine_test(
  ...
  function()
    ...
    test.socket.zigbee:__expect_send({ mock_device.id,
      cluster_base.write_manufacturer_specific_attribute(mock_device, PRIVATE_CLUSTER_ID,
        0x0002, MFG_CODE, data_types.Uint8, 2)
    })
  end
)
...
test.register_coroutine_test(
  "capability right_control backControl medium and driver send medium ",
  function()
    test.socket.capability:__queue_receive({
      mock_device.id,
      { capability = custom_capabilities.right_control.ID, component = "main", command ="backControl" , args = {"medium"}}
    })
    test.socket.zigbee:__expect_send({ mock_device.id,
      cluster_base.write_manufacturer_specific_attribute(mock_device, PRIVATE_CLUSTER_ID,
...
test.register_coroutine_test(
  "capability right_control waistControl medium and driver send medium ",
  function()
    test.socket.capability:__queue_receive({
      mock_device.id,
      { capability = custom_capabilities.right_control.ID, component = "main", command ="waistControl" , args = {"medium"}}
    })
    test.socket.zigbee:__expect_send({ mock_device.id,
      cluster_base.write_manufacturer_specific_attribute(mock_device, PRIVATE_CLUSTER_ID,
...
test.register_coroutine_test(
  "capability right_control hipControl medium and driver send medium ",
  function()
    test.socket.capability:__queue_receive({
      mock_device.id,
      { capability = custom_capabilities.right_control.ID, component = "main", command ="hipControl" , args = {"medium"}}
    })
    test.socket.zigbee:__expect_send({ mock_device.id,
      cluster_base.write_manufacturer_specific_attribute(mock_device, PRIVATE_CLUSTER_ID,
