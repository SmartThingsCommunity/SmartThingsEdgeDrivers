...
EventList.enum_fields = {
}

function EventList:augment_type(base_type_obj)
  base_type_obj.field_name = self.NAME
  base_type_obj.pretty_print = self.pretty_print
end

function EventList.pretty_print(value_obj)
  return string.format("%s.%s", value_obj.field_name or value_obj.NAME, EventList.enum_fields[value_obj.value])
end
