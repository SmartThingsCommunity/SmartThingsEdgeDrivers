...
local zigbee_window_treatment_driver_template = {
  ...
  sub_drivers = { require("vimar"), require("aqara"), require("feibit"), require("somfy"), require("IKEA"), require("rooms-beautiful"), require("axis"), require("yoolax"), require("micronic")  },
  lifecycle_handlers = {
    added = added_handler
  }
}
