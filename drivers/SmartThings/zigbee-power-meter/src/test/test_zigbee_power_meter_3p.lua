...
local mock_device = test.mock_device.build_test_zigbee_device({
  profile = t_utils.get_profile_definition("power-meter-3p.yml"),
  zigbee_endpoints = {
    [1] = {
      id = 1,
...
test.register_message_test(
    "ActivePower Report for PhaseB should be handled. Sensor value is in W, capability attribute value is in hectowatts",
    {
      {
        channel = "zigbee",
        direction = "receive",
        message = { mock_device.id, ElectricalMeasurement.attributes.ActivePowerPhB:build_test_attr_report(mock_device,
                                                                                                        27) },
      },
      {
        channel = "capability",
...
test.register_message_test(
  "RMSCurrent Report for PhaseB should be handled",
  {
    {
      channel = "zigbee",
      direction = "receive",
      message = { mock_device.id, ElectricalMeasurement.attributes.RMSCurrentPhB:build_test_attr_report(mock_device,
                                                                                                      34) },
    },
    {
      channel = "capability",
...
test.register_message_test(
  "RMSVoltage Report for PhaseB should be handled",
  {
    {
      channel = "zigbee",
      direction = "receive",
      message = { mock_device.id, ElectricalMeasurement.attributes.RMSVoltagePhB:build_test_attr_report(mock_device,
                                                                                                      22000) },
    },
    {
      channel = "capability",
...
test.register_message_test(
    "ActivePower Report for PhaseC should be handled. Sensor value is in W, capability attribute value is in hectowatts",
    {
      {
        channel = "zigbee",
        direction = "receive",
        message = { mock_device.id, ElectricalMeasurement.attributes.ActivePowerPhC:build_test_attr_report(mock_device,
                                                                                                        27) },
      },
      {
        channel = "capability",
...
test.register_message_test(
  "RMSCurrent Report for PhaseC should be handled",
  {
    {
      channel = "zigbee",
      direction = "receive",
      message = { mock_device.id, ElectricalMeasurement.attributes.RMSCurrentPhC:build_test_attr_report(mock_device,
                                                                                                      34) },
    },
    {
      channel = "capability",
...
test.register_message_test(
  "RMSVoltage Report for PhaseC should be handled",
  {
    {
      channel = "zigbee",
      direction = "receive",
      message = { mock_device.id, ElectricalMeasurement.attributes.RMSVoltagePhC:build_test_attr_report(mock_device,
                                                                                                      22000) },
    },
    {
      channel = "capability",
...
test.register_coroutine_test(
  ...
  function()
    ...
    test.socket.zigbee:__expect_send({
      mock_device.id,
      ElectricalMeasurement.attributes.ActivePowerPhB:configure_reporting(mock_device, 30, 120, 0)
    })
    test.socket.zigbee:__expect_send({
      mock_device.id,
      ElectricalMeasurement.attributes.RMSVoltagePhB:configure_reporting(mock_device, 30, 120, 0)
    })
    test.socket.zigbee:__expect_send({
      mock_device.id,
      ElectricalMeasurement.attributes.RMSCurrentPhB:configure_reporting(mock_device, 30, 120, 0)
    })
    test.socket.zigbee:__expect_send({
      mock_device.id,
      ElectricalMeasurement.attributes.ActivePowerPhC:configure_reporting(mock_device, 30, 120, 0)
    })
    test.socket.zigbee:__expect_send({
      mock_device.id,
      ElectricalMeasurement.attributes.RMSVoltagePhC:configure_reporting(mock_device, 30, 120, 0)
    })
    test.socket.zigbee:__expect_send({
      mock_device.id,
      ElectricalMeasurement.attributes.RMSCurrentPhC:configure_reporting(mock_device, 30, 120, 0)
    })
    test.socket.zigbee:__expect_send({
      mock_device.id,
