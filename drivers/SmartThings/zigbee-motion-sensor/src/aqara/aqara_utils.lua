...
aqara_utils.MOTION_DETECTED_UINT32 = MOTION_DETECTED_UINT32
local MOTION_DETECTED_NUMBER = 1
aqara_utils.MOTION_DETECTED_NUMBER = MOTION_DETECTED_NUMBER

local UNOCCUPIED_TIMER = "unoccupiedTimer"
aqara_utils.UNOCCUPIED_TIMER = UNOCCUPIED_TIMER
...
aqara_utils.PREF_SENSITIVITY_KEY = PREF_SENSITIVITY_KEY
local PREF_SENSITIVITY_VALUE_HIGH = 3
aqara_utils.PREF_SENSITIVITY_VALUE_HIGH = PREF_SENSITIVITY_VALUE_HIGH
local PREF_SENSITIVITY_VALUE_MEDIUM = 2
aqara_utils.PREF_SENSITIVITY_VALUE_MEDIUM = PREF_SENSITIVITY_VALUE_MEDIUM
local PREF_SENSITIVITY_VALUE_LOW = 1
aqara_utils.PREF_SENSITIVITY_VALUE_LOW = PREF_SENSITIVITY_VALUE_LOW
