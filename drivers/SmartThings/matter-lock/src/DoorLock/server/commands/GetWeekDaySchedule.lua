...
GetWeekDaySchedule.ID = 0x000C
GetWeekDaySchedule.field_defs = {
  {
    name = "week_day_index",
    field_id = 0,
    is_nullable = false,
...
function GetWeekDaySchedule:init(device, endpoint_id, week_day_index, user_index)
  local out = {}
...
function GetWeekDaySchedule:augment_type(base_type_obj)
  local elems = {}
...
function GetWeekDaySchedule:deserialize(tlv_buf)
