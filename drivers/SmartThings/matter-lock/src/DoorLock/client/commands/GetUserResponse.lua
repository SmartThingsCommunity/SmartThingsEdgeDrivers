...
GetUserResponse.field_defs = {
  ...
  },
  {
    ...
    is_nullable = true,
    is_optional = false,
    data_type = require "DoorLock.types.CredentialRuleEnum",
  },
  {
    name = "credentials",
    field_id = 6,
...
function GetUserResponse:build_test_command_response(device, endpoint_id, user_index, user_name, user_uniqueid, user_status, user_type, credential_rule, credentials, creator_fabric_index, last_modified_fabric_index, next_user_index, interaction_status)
  local function init(self, device, endpoint_id, user_index, user_name, user_uniqueid, user_status, user_type, credential_rule, credentials, creator_fabric_index, last_modified_fabric_index, next_user_index)
    local out = {}
    local args = {user_index, user_name, user_uniqueid, user_status, user_type, credential_rule, credentials, creator_fabric_index, last_modified_fabric_index, next_user_index}
  ...
  local self_request =  init(self, device, endpoint_id, user_index, user_name, user_uniqueid, user_status, user_type, credential_rule, credentials, creator_fabric_index, last_modified_fabric_index, next_user_index)
