...
local unmigrated_matter_lock_driver = {
  NAME = "Unmigrated Matter Lock Driver",
  matter_handlers = {
    attr = {
      [DoorLock.ID] = {
  ...
  capability_handlers = {
    ...
    [capabilities.lockCodes.ID] = {
      ...
      [capabilities.lockCodes.commands.migrate.NAME] = handle_migrate,
    },
  },
  ...
  can_handle = require("unmigrated-matter-lock.can_handle"),
}
