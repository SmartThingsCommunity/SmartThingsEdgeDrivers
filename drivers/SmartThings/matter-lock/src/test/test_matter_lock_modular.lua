...
test.register_coroutine_test(
  "Test modular lock profile change when BatChargeLevel and BatPercentRemaining attributes are available",
  function()
    test.socket.matter:__queue_receive(
      {
        mock_device.id,
...
test.register_coroutine_test(
  ...
  function()
    ...
    mock_device_unlatch:expect_metadata_update({ profile = "lock-modular", optional_component_capabilities = {{"main", {}}} })
  end,
  { test_init = test_init_unlatch }
)

test.register_coroutine_test(
  "Test lock-unlatch profile change with unlatch when BatChargeLevel attribute is available",
  function()
    test.socket.matter:__queue_receive(
      {
        mock_device_unlatch.id,
    ...
    mock_device_unlatch:expect_metadata_update({ profile = "lock-modular", optional_component_capabilities = {{"main", {"batteryLevel"}}} })
  end,
  { test_init = test_init_unlatch }
)

test.register_coroutine_test(
  "Test modular lock profile change with unlatch when BatChargeLevel and BatPercentRemaining attributes are available",
  function()
    test.socket.matter:__queue_receive(
      {
        mock_device_unlatch.id,
    ...
    mock_device_unlatch:expect_metadata_update({ profile = "lock-modular", optional_component_capabilities = {{"main", {"battery"}}} })
  end,
  { test_init = test_init_unlatch }
)
...
test.register_coroutine_test(
  ...
  function()
    ...
    test.socket.capability:__expect_send(
      mock_device_user_pin:generate_test_message("main", capabilities.lock.supportedLockValues({"locked", "unlocked", "not fully locked"}, {visibility = {displayed = false}}))
    )
    test.socket.capability:__expect_send(
...
test.register_coroutine_test(
  "Test modular lock profile change with user, pin. schedule, and unlatch supported when BatChargeLevel and BatPercentRemaining attributes are available",
  function()
    test.socket.matter:__queue_receive(
      {
    ...
    mock_device_user_pin_schedule_unlatch:expect_metadata_update({ profile = "lock-modular", optional_component_capabilities = {{"main", {"lockUsers", "lockCredentials", "lockSchedules", "battery"}}} })
