...
local function test_init_no_battery()
  ...
  subscribe_request:merge(clusters.DoorLock.attributes.MinPINCodeLength:subscribe(mock_device_no_battery))
  subscribe_request:merge(clusters.DoorLock.attributes.MaxPINCodeLength:subscribe(mock_device_no_battery))
  subscribe_request:merge(clusters.DoorLock.attributes.NumberOfTotalUsersSupported:subscribe(mock_device_no_battery))
  subscribe_request:merge(clusters.DoorLock.attributes.NumberOfPINUsersSupported:subscribe(mock_device_no_battery))
  subscribe_request:merge(clusters.DoorLock.attributes.RequirePINforRemoteOperation:subscribe(mock_device_no_battery))
