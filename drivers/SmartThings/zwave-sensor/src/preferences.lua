...
local devices = {
  ...
  FIBARO_DOOR_WINDOW_SENSOR_WITH_TEMPERATURE = {
    ...
    PARAMETERS = {
      ...
      delayOfTamperAlarmCancellation = {parameter_number = 30, size = 2},
      reportingTamperAlarmCancellation = {parameter_number = 31, size = 1},
      tempMeasurementInterval = {parameter_number = 50, size = 2},
      tempReportsThreshold = {parameter_number = 51, size = 2},
      intervalOfTemperatureReports = {parameter_number = 52, size = 2},
