...
function Start:init(device, endpoint_id)
  local out = {}
  local args = {}
...
function Start:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

function Start:augment_type(base_type_obj)
  local elems = {}
...
function Start:deserialize(tlv_buf)
