...
function Resume:init(device, endpoint_id)
  local out = {}
  local args = {}
  ...
  setmetatable(out, {
    __index = Resume,
    __tostring = Resume.pretty_print
  })
...
function Resume:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

function Resume:augment_type(base_type_obj)
  local elems = {}
...
function Resume:deserialize(tlv_buf)
