...
local status, aliases = pcall(require, "st.matter.clusters.aliases.RvcOperationalState.server.commands")
if status then
  aliases:add_to_class(RvcOperationalStateServerCommands)
end
