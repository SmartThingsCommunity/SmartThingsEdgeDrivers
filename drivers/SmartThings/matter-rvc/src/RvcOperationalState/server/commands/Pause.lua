...
function Pause:init(device, endpoint_id)
  local out = {}
  local args = {}
...
function Pause:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

function Pause:augment_type(base_type_obj)
  local elems = {}
...
function Pause:deserialize(tlv_buf)
