...
local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.RvcOperationalState.types.OperationalStateEnum")
if has_aliases then
  aliases:add_to_class(OperationalStateEnum)
end
