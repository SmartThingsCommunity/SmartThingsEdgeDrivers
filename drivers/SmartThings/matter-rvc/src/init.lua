...
-- Helper functions --
local function update_supported_mode(device, current_run_mode, operating_state)
  device.log.info(string.format("update_supported_mode: %s, %s", current_run_mode, operating_state))
