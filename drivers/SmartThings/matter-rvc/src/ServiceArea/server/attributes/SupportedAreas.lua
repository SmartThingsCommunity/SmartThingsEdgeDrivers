...
function SupportedAreas:new_value(...)
...
function SupportedAreas:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function SupportedAreas:subscribe(device, endpoint_id)
...
function SupportedAreas:set_parent_cluster(cluster)
...
function SupportedAreas:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function SupportedAreas:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(SupportedAreas, {__call = SupportedAreas.new_value, __index = SupportedAreas.base_type})
