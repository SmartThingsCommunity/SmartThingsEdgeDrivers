...
--- @alias LandmarkInfoStruct
--- @class st.matter.clusters.ServiceArea.types.LandmarkInfoStruct: st.matter.data_types.Structure
---
--- @field public landmark_tag Global.types.LandmarkTag
--- @field public relative_position_tag Global.types.RelativePositionTag
local LandmarkInfoStruct = {}
local new_mt = StructureABC.new_mt({NAME = "LandmarkInfoStruct", ID = data_types.name_to_id_map["Structure"]})

LandmarkInfoStruct.field_defs = {
  {
    name = "landmark_tag",
    field_id = 0,
    is_nullable = false,
    is_optional = false,
    data_type = require "Global.types.LandmarkTag",
  },
  {
    name = "relative_position_tag",
    field_id = 1,
    is_nullable = true,
    is_optional = false,
    data_type = require "Global.types.RelativePositionTag",
  },
}

LandmarkInfoStruct.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
LandmarkInfoStruct.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = LandmarkInfoStruct.init
new_mt.__index.serialize = LandmarkInfoStruct.serialize

LandmarkInfoStruct.augment_type = function(self, val)
  local elems = {}
...
setmetatable(LandmarkInfoStruct, new_mt)

return LandmarkInfoStruct
