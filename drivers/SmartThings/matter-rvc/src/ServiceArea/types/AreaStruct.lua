...
---
--- @field public area_id st.matter.data_types.Uint32
--- @field public map_id st.matter.data_types.Uint32
--- @field public area_info ServiceArea.types.AreaInfoStruct
local AreaStruct = {}
local new_mt = StructureABC.new_mt({NAME = "AreaStruct", ID = data_types.name_to_id_map["Structure"]})

AreaStruct.field_defs = {
  {
    name = "area_id",
    field_id = 0,
    is_nullable = false,
  ...
  },
  {
    ...
    is_nullable = false,
    is_optional = false,
    data_type = require "ServiceArea.types.AreaInfoStruct",
  },
}

AreaStruct.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
AreaStruct.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = AreaStruct.init
new_mt.__index.serialize = AreaStruct.serialize

AreaStruct.augment_type = function(self, val)
  local elems = {}
...
setmetatable(AreaStruct, new_mt)
