...
--- @alias AreaInfoStruct
--- @class st.matter.clusters.ServiceArea.types.AreaInfoStruct: st.matter.data_types.Structure
---
--- @field public location_info Global.types.LocationDescriptorStruct
--- @field public landmark_info ServiceArea.types.LandmarkInfoStruct
local AreaInfoStruct = {}
local new_mt = StructureABC.new_mt({NAME = "AreaInfoStruct", ID = data_types.name_to_id_map["Structure"]})

AreaInfoStruct.field_defs = {
  {
    name = "location_info",
    field_id = 0,
    is_nullable = true,
    is_optional = false,
    data_type = require "Global.types.LocationDescriptorStruct",
  },
  {
    name = "landmark_info",
    field_id = 1,
    is_nullable = true,
    is_optional = false,
    data_type = require "ServiceArea.types.LandmarkInfoStruct",
  },
}

AreaInfoStruct.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
AreaInfoStruct.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = AreaInfoStruct.init
new_mt.__index.serialize = AreaInfoStruct.serialize

AreaInfoStruct.augment_type = function(self, val)
  local elems = {}
...
setmetatable(AreaInfoStruct, new_mt)
