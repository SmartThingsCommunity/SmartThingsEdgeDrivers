...
ErrorStateStruct.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
ErrorStateStruct.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = ErrorStateStruct.init
new_mt.__index.serialize = ErrorStateStruct.serialize

ErrorStateStruct.augment_type = function(self, val)
  local elems = {}
