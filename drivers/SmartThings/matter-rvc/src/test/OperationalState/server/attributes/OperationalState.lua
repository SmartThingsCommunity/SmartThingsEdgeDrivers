...
--- @class st.matter.clusters.OperationalState.OperationalState
--- @alias OperationalState
---
--- @field public ID number 0x0004 the ID of this attribute
--- @field public NAME string "OperationalState" the name of this attribute
--- @field public data_type OperationalState.types.OperationalStateEnum the data type of this attribute
...
--- Create a OperationalStateEnum object of this attribute with any additional features provided for the attribute
--- This is also usable with the OperationalState(...) syntax
---
--- @vararg vararg the values needed to construct a OperationalStateEnum
--- @return OperationalState.types.OperationalStateEnum
