...
--- @class st.matter.clusters.OperationalState.OperationalStateList
--- @alias OperationalStateList
---
--- @field public ID number 0x0003 the ID of this attribute
--- @field public NAME string "OperationalStateList" the name of this attribute
