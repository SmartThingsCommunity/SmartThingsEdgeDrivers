...
-----------------------------------------------------------
-- OperationalState command Start
-----------------------------------------------------------

--- @class st.matter.clusters.OperationalState.Start
--- @alias Start
---
--- @field public ID number 0x0002 the ID of this command
--- @field public NAME string "Start" the name of this command
local Start = {}
...
---
--- @param self Start the template class for this command
