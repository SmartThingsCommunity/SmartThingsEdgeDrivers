...
-----------------------------------------------------------
-- OperationalState command Resume
-----------------------------------------------------------

--- @class st.matter.clusters.OperationalState.Resume
--- @alias Resume
---
--- @field public ID number 0x0003 the ID of this command
--- @field public NAME string "Resume" the name of this command
local Resume = {}
...
---
--- @param self Resume the template class for this command
