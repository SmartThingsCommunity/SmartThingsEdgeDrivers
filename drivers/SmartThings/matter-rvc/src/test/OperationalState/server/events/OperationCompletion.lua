...
--- @class st.matter.clusters.OperationalState.OperationCompletion
--- @alias OperationCompletion
---
--- @field public ID number 0x0001 the ID of this event
--- @field public NAME string "OperationCompletion" the name of this event
--- @field public completion_error_code st.matter.data_types.Uint8
--- @field public total_operational_time st.matter.data_types.Uint32
--- @field public paused_time st.matter.data_types.Uint32
local OperationCompletion = {
  ID = 0x0001,
  NAME = "OperationCompletion",
  base_type = data_types.Structure,
}

OperationCompletion.field_defs = {
  {
...
function OperationCompletion:augment_type(base_type_obj)
  local elems = {}
...
function OperationCompletion:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return st.matter.interaction_model.InteractionRequest
function OperationCompletion:subscribe(device, endpoint_id)
...
function OperationCompletion:build_test_event_report(
  device,
  endpoint_id,
  fields,
  status
  ...
  data.elements = {}
  data.num_elements = 0
  setmetatable(data, StructureABC.new_mt({NAME = "OperationCompletionEventData", ID = 0x15}))
...
function OperationCompletion:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

function OperationCompletion:set_parent_cluster(cluster)
