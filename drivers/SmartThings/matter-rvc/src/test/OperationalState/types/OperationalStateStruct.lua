...
--- @alias OperationalStateStruct
--- @class st.matter.clusters.OperationalState.types.OperationalStateStruct: st.matter.data_types.Structure
---
--- @field public operational_state_id st.matter.data_types.Uint8
--- @field public operational_state_label st.matter.data_types.UTF8String1
