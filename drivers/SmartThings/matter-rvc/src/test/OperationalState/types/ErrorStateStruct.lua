...
--- @alias ErrorStateStruct
--- @class st.matter.clusters.OperationalState.types.ErrorStateStruct: st.matter.data_types.Structure
---
--- @field public error_state_id st.matter.data_types.Uint8
--- @field public error_state_label st.matter.data_types.UTF8String1
--- @field public error_state_details st.matter.data_types.UTF8String1
