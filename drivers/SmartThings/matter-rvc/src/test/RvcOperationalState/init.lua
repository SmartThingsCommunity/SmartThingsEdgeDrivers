...
local OperationalStateClientCommands = require "OperationalState.client.commands"
...
--- @field public attributes OperationalStateServerAttributes | OperationalStateClientAttributes
--- @field public commands OperationalStateServerCommands | OperationalStateClientCommands
--- @field public types OperationalStateTypes

local OperationalState = {}

OperationalState.ID = 0x0061
