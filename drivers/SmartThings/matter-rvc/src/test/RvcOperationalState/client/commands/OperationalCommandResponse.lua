...
-----------------------------------------------------------
-- OperationalState command OperationalCommandResponse
-----------------------------------------------------------

--- @class st.matter.clusters.OperationalState.OperationalCommandResponse
--- @alias OperationalCommandResponse
---
--- @field public ID number 0x0004 the ID of this command
--- @field public NAME string "OperationalCommandResponse" the name of this command
--- @field public command_response_state OperationalState.types.ErrorStateStruct
...
--- @param command_response_state OperationalState.types.ErrorStateStruct
