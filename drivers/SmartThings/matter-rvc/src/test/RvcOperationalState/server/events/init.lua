...
--- @class OperationalStateEvents
---
--- @field public OperationalError OperationalState.server.events.OperationalError
--- @field public OperationCompletion OperationalState.server.events.OperationCompletion
